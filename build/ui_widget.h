...
"}"));
        ...
        ajouterButton = new QPushButton(layoutWidget);
...
"}"));
        ...
        verticalLayoutButtons->addWidget(ajouterButton);
...
"}"));
        ...
        verticalLayoutButtons->addWidget(modifierButton);

        supprimerButton = new QPushButton(layoutWidget);
...
"}"));
        ...
        verticalLayoutButtons->addWidget(supprimerButton);
        ...
        tableServices->setItem(0, 0, __qtablewidgetitem15);
        tableServices->setObjectName("tableServices");
        tableServices->setGeometry(QRect(710, 240, 881, 341));
...
"}"));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        ajouterButton->setText(QCoreApplication::translate("Widget", "Ajouter", nullptr));
