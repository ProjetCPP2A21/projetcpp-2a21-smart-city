...
"}"));
        ...
        formLayout->setWidget(4, QFormLayout::ItemRole::FieldRole, combo_type);

        label_type = new QLabel(layoutWidget_2);
        label_type->setObjectName("label_type");

        formLayout->setWidget(4, QFormLayout::ItemRole::LabelRole, label_type);

        label_budget = new QLabel(layoutWidget_2);
        label_budget->setObjectName("label_budget");

        formLayout->setWidget(5, QFormLayout::ItemRole::LabelRole, label_budget);
...
"}"));
        ...
        formLayout->setWidget(5, QFormLayout::ItemRole::FieldRole, spin_budget);
...
"}"));
        ...
        formLayout->setWidget(7, QFormLayout::ItemRole::FieldRole, combo_state);
...
"}"));
        ...
        formLayout->setWidget(8, QFormLayout::ItemRole::FieldRole, dateEdit_date);

        label_priority = new QLabel(layoutWidget_2);
        label_priority->setObjectName("label_priority");

        formLayout->setWidget(6, QFormLayout::ItemRole::LabelRole, label_priority);

        label_state = new QLabel(layoutWidget_2);
        label_state->setObjectName("label_state");

        formLayout->setWidget(7, QFormLayout::ItemRole::LabelRole, label_state);

        label_date = new QLabel(layoutWidget_2);
        label_date->setObjectName("label_date");

        formLayout->setWidget(8, QFormLayout::ItemRole::LabelRole, label_date);
...
"}"));
        ...
        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, lineEdit_responsable);

        label_resp = new QLabel(layoutWidget_2);
        label_resp->setObjectName("label_resp");

        formLayout->setWidget(2, QFormLayout::ItemRole::LabelRole, label_resp);
...
"}"));
        ...
        formLayout->setWidget(6, QFormLayout::ItemRole::FieldRole, combo_priority);
