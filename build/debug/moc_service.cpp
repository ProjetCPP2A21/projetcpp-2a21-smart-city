...
struct qt_meta_stringdata_CLASSServiceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSServiceENDCLASS = QtMocHelpers::stringData(
    "Service",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSServiceENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Service::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSServiceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSServiceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSServiceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Service::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSServiceENDCLASS.stringdata0))
