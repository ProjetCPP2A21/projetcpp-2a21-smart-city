    ...
    , ui(new Ui::Widget)
{
    ...
    connect(ui->btnStats, &QPushButton::clicked,
            this, &Widget::afficherStatistiques);
...
// ========== EXPORTER PDF ==========
void Widget::on_btnExportPDF_clicked()
{
    ...
    int cols = ui->tableServices->columnCount();
    for (int i = 0; i < rows; ++i) {
        ...
        for (int j = 0; j < cols; ++j) {
            QString val = ui->tableServices->item(i, j)->text();
...
void Widget::afficherStatistiques()
{
