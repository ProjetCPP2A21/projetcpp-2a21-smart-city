...
namespace {
struct qt_meta_tag_ZN7serviceE_t {};
} // unnamed namespace

template <> constexpr inline auto service::qt_create_metaobjectdata<qt_meta_tag_ZN7serviceE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<service, qt_meta_tag_ZN7serviceE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject service::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7serviceE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7serviceE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7serviceE_t>.metaTypes,
    nullptr
} };
...
void *service::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7serviceE_t>.strings))
